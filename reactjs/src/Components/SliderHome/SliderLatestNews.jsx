...
import newsBg1 from "../img/latest-news/news-bg-1.jpg";
import newsBg2 from "../img/latest-news/news-bg-2.jpg";
import newsBg3 from "../img/latest-news/news-bg-3.jpg";

const SliderLatestNews = () => {
  return (
    <div>
